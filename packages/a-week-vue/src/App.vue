...
<template>
  ...
  <div id="nav">
    ...
    <br />
    <RouterLink to="/databinding">5.3.1 Data Binding</RouterLink> |
    ...
    <br />
    <RouterLink to="/databindingcheckbox">5.3.3.5 Data Binding Checkbox</RouterLink> |
    <RouterLink to="/databindingradio">5.3.3.6 Data Binding Radio</RouterLink>
    <br />
